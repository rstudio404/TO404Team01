...
baseplot_userT + geom_point(size = 2, alpha = 0.5)+ scale_color_manual(values=c("yellowgreen", "darkgreen")) + geom_smooth() + facet_wrap(~usertype)
```
...
baseplot_age + geom_point(size = 2, alpha = .2)+ scale_color_manual(values=c("yellowgreen", "darkgreen")) + geom_smooth() + facet_wrap(~ agegroup)
```
...
baseplot_Week + geom_point(size = 3, alpha = .5 )+ scale_color_manual(values=c("yellowgreen", "darkgreen")) + geom_smooth()
baseplot_gender <- ggplot(data = combined_gender, aes(x = AWND, y = count, colour = dayid))
baseplot_gender + geom_point(size = 3, alpha = .5)+ scale_color_manual(values=c("yellowgreen", "darkgreen")) + geom_smooth() + facet_wrap(~ gender)
```
...
baseplot_userT + geom_point(size = 3, alpha = .5)+ scale_color_manual(values=c("yellowgreen", "darkgreen")) + geom_smooth() + facet_wrap(~ usertype)
baseplot_age <- ggplot(data = combined_age, aes(x = AWND, y = speed, colour = dayid))
baseplot_age + geom_point(size = 3, alpha = .5)+ scale_color_manual(values=c("yellowgreen", "darkgreen")) + geom_smooth() + facet_wrap(~ agegroup)
```
...
baseplot_period + geom_point(size = 3, alpha = 0.5)+ scale_color_manual(values=c("yellowgreen", "darkgreen")) + geom_smooth() + facet_grid(~period)
